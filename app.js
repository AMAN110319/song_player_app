...
songs.forEach((e) => {
  const { id, songName, poster } = e; //destructure out from them
...
Array.from(document.getElementsByClassName("playListPlay")).forEach((e) => {
  e.addEventListener("click", (e1) => {
    ...
    music.play();
    // ye check karne ke liye kaun sa baja hai iske liye filter lagaya h hamne
...
music.addEventListener("timeupdate", () => {
  ...
  let progressbar = parseInt((music_curr / duration) * 100);
